...
print("PytickerSymbols imported")
import yfinance as yf
print("yFinance imported")
import matplotlib.pyplot as plt
print("matplotLib imported")
from sklearn.model_selection import train_test_split
print("train_test_split from sklearn imported")
import xgboost as xgb
print("xgb imported")
from sklearn.metrics import mean_squared_error
print("mean_squared_error from sklearn imported")
from tensorflow.keras.models import Sequential
print("Sequential from tensorflow imported")
from tensorflow.keras.layers import Dense, Dropout, LSTM
print("Dense, Dropout, and LSTM from tensorflow imported")
from tensorflow.keras.optimizers import Adam
print("Adam from tensorflow imported")
from tensorflow.keras.callbacks import EarlyStopping
print("EarlyStopping from tensorflow imported")
from sklearn.preprocessing import StandardScaler
print("StandardScaler form sklearn imported")
import datetime
...
top_100 = yf.download(tickers, start_date, end_date, auto_adjust=True).dropna(axis = 1, how = 'all')
top_100_data = pd.DataFrame(top_100)

#Download of any ticker required
def downloadTicker(ticker):
    data = yf.download(ticker, start_date, end_date, auto_adjust=True).dropna(axis = 1, how = 'all')
...
predictShortorLongTerm(stock_name, "short-term")
